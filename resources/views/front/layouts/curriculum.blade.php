...
<html lang="en">
    ...
    <body id="page-top">
        ...
        @include('frontend.layouts.curriculum.nav_star')
        @include('frontend.layouts.curriculum.intro')
        @include('frontend.layouts.curriculum.about')
        @include('frontend.layouts.curriculum.skills')
        @include('frontend.layouts.curriculum.work')
        @include('frontend.layouts.curriculum.contact')
