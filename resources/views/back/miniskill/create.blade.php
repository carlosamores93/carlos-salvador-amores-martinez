...
@section('content')
	<div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" class="form-horizontal" action="{{ route('miniskill.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='title' class="form-control" id="email1" placeholder="Miniskill name" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="number" name="progress" class="form-control" placeholder="50" max="100" min="0" aria-label="Progress" aria-describedby="basic-addon2">
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn btn-primary">Store miniskill</button>
                            </div>
                        </div>
                    </form>
                </div>
