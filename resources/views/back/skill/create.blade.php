...
@section('content')
	<div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" class="form-horizontal" action="{{ route('skill.store') }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='title' class="form-control" id="email1" placeholder="Skill name" required>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="border-top">
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn btn-primary">Store skill</button>
                            </div>
                        </div>
                    </form>
                </div>
